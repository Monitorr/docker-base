...
ENV S6_REL=2.1.0.2 S6_ARCH=amd64 S6_BEHAVIOUR_IF_STAGE2_FAILS=2 TZ=Etc/UTC

LABEL base.maintainer="monitorr, jonfinley"
LABEL base.s6.rel=${S6_REL} base.s6.arch=${S6_ARCH}

LABEL org.label-schema.name="monitorr/base" \
  org.label-schema.description="Baseimage for Monitorr" \
  org.label-schema.url="https://monitorr.app/" \
  org.label-schema.vcs-url="https://github.com/monitorr/docker-base" \
